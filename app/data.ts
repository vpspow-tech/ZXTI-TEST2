...
export const TYPE_LIBRARY: Record<string, TypeEntry> = {
  "GFG": { code: "GFG", cn: "卷王附体", intro: "这个点下班？不可能的。", desc: `恭喜你，你就是传说中的卷王附体。你对加班的理解超越了大多数人，你不是在上班，你是在修仙。别人下班你加班，别人周末你加班，别人晋升你还是加班。你的工位就是你的家，你的电脑就是你的爱人。卷王的结局只有两个：要么卷到高层，要么卷进医院。` },
  "MASTER": { code: "MASTER", cn: "职场懂王", intro: "这个问题我来回答一下。", desc: `恭喜你，你是办公室里最愿意分享知识的那个人。你的职场信条是：我不说你们永远不懂。你的会议发言永远比老板还长，你的朋友圈永远在转发行业分析。你不是不懂，是太懂了，懂到别人已经不想听你懂了。` },
  "EXCEED": { code: "EXCEED", cn: "KPI超标侠", intro: "这个月KPI？提前完成了。", desc: `恭喜你，你是KPI的奴隶，也是KPI的主人。你的人生字典里没有"不够"，只有"超额"。老板定的目标你嫌低，自己给自己加码是你的日常。但夜深人静的时候，你也会想：我这么拼，到底是为了什么？为了下一个KPI。` },
  "PERF": { code: "PERF", cn: "完美主义社畜", intro: "这个PPT第五遍了，还是不够好。", desc: `恭喜你，你是办公室里的完美主义战士。你对细节的追求已经超越了工作的需要，一份文档你能调三遍格式，一个配色你能换十次。你最大的痛苦不是做不好，是别人觉得你做得太慢。但说实话，你自己也不知道什么时候该停下来。` },
  "REWORK": { code: "REWORK", cn: "反复横跳侠", intro: "这个方案推翻了，我们重来。", desc: `恭喜你，你是职场不确定性大师。你的工作状态永远在推翻重来，上午定的方向下午就变，昨天确认的方案今天就改。你不是在工作，你是在进行一场名为"换个方向"的持续运动。老板已经习惯了你的一变再变，学会了等你自然稳定再验收。` },
  "BOSS2": { code: "BOSS2", cn: "全能打工人", intro: "写代码？做PPT？谈客户？都我来。", desc: `恭喜你，你就是那个一个人撑起整个部门的人。别人只会一样，你会三样；别人下班了，你还在。你是公司最离不开的人，也是最廉价的人。全能打工人，你的工资配不上你的能力，你的领导看不见你的付出。` },
  "FOMO": { code: "FOMO", cn: "职场焦虑症", intro: "老板发消息了，是不是我又出问题了？", desc: `恭喜你，你是职场焦虑本虑。你对老板的消息过敏，你对话术变更敏感，你对会议邀请惊恐。别人上班是赚钱，你上班是渡劫。你的人生一半在睡觉，一半在想工作，真正的工作反而没干多少。焦虑症晚期，但老板觉得你工作态度有问题。` },
  "COLORG": { code: "COLORG", cn: "职场人设狂", intro: "我在职场是温柔可靠的职场姐姐。", desc: `恭喜你，你是职场变色龙。你在老板面前是一个样子，在同事面前是另一个样子，在客户面前又是第三个样子。你的人设比你的工作能力更丰富，你的演技比你的专业度更精湛。职场人设狂魔，最终会迷失在各种人设里，不知道哪个才是真正的自己。` },
  "ECO": { code: "ECO", cn: "职场清流", intro: "我不参与这些破事。", desc: `恭喜你，你是办公室里的佛系存在。你不争不抢，不站队不八卦，你觉得那些搞关系的都是傻子。你以为自己是出淤泥而不染，其实只是你在逃避。职场清流的下场往往是：被当成空气，或者被淤泥吞掉。` },
  "THINKL": { code: "THINKL", cn: "职场哲学家", intro: "所以，工作的意义到底是什么？", desc: `恭喜你，你是职场尼采。你每天不是在工作，是在思考工作的意义。你可以在开会的时候神游物外，思考人类为什么要上班。你对KPI的理解已经超越了数字，上升到了存在主义的高度。别人在干活，你在思考为什么要干活。哲学家型的员工，老板又爱又恨——爱你的深度，恨你的飘忽。` },
  "TINDER": { code: "TINDER", cn: "摸鱼大师", intro: "我就看看网页，不干别的。", desc: `恭喜你，你是摸鱼界的传奇。你的电脑永远开着工作文档，你的眼睛永远盯着与工作无关的内容。你是"看起来很忙"这门艺术的集大成者。摸鱼大师的境界是：摸了半天鱼，老板还觉得你很忙。但，摸鱼一时爽，一直摸鱼一直爽吗？` },
  "WATCHL": { code: "WATCHL", cn: "监控狂魔", intro: "老板今天看我的眼神不对。", desc: `恭喜你，你是职场洞察力的极端。你对办公室政治的理解已经超越了常人，你能在老板咳嗽一声就知道他要骂人。但这种敏感也把你累得半死——别人上班是工作，你上班是读空气。监控狂魔的下场：看到了太多，看清了太少。` },
  "SHAFT": { code: "SHAFT", cn: "隐形大佬", intro: "我就一普通员工，没什么野心。", desc: `恭喜你，你是职场扫地僧。表面上你是个普通员工，实际上你家可能有十套房或者有个好爹。你的银行卡余额比你说的多，你的工作热情比你表现的低。隐形大佬的痛：低调太久，连自己都信了。` },
  "COMP": { code: "COMP", cn: "卷性能手", intro: "我下班早？我只是效率高而已。", desc: `恭喜你，你是效率婊。你的工位干净得像没人坐过，你的待办清得像没接过任务，你的日程空得像不饱和。卷性能手，你不是在工作，你是在表演工作。你用四两拨千斤的方式，让所有人觉得你很轻松——但只有你自己知道，你花了多少心思在"看起来很轻松"这件事上。` },
  "SIBL": { code: "SIBL", cn: "PPT纺织工", intro: "这个动画要柔和，这个配色要专业。", desc: `恭喜你，你是PPT纺织工。你的工作内容不是完成业务，是把业务装进一个漂亮的壳子里。你的PPT有32种字体，48种配色方案，64种动画效果。但说实话，内容一页就够写完的东西，你用了三十页。PPT纺织工的命运：永远在纺织，永远不被看见。` },
  "FLEX": { code: "FLEX", cn: "职场老油条", intro: "我知道了，这个明天再说。", desc: `恭喜你，你是职场生存大师。你的技能不是工作能力，是"如何在职场优雅地不干活"。你知道每一件事的边界在哪里，你知道每一个老板的底线在哪里。老油条的信条：不是我的活不接，不是我的锅不背。你的每一天都在用力地"少干点"，精疲程度超过所有人。` },
  "CTRL2": { code: "CTRL2", cn: "汇报艺术家", intro: "这个季度的成果主要是……", desc: `恭喜你，你是汇报艺术家。你的工作能力不一定最强，但你的汇报能力一定最顶级。你能把一个星期的摸鱼说成两周的攻坚，你能把失败的项目说成"大胆的尝试"。汇报艺术家的人生真理：干得好不如说得好。但常在河边走，哪有不湿鞋？` },
  "DUMP": { code: "DUMP", cn: "佛系打工人", intro: "涨薪？随缘吧。", desc: `恭喜你，你是职场躺平协会会员。你不争不抢，不急不躁，老板夸你无所谓，老板骂你也无所谓。你的人生哲学是：地球离了谁都转，我的班上了就够了。佛系打工人的内心独白：不是不想争，是争也争不过，算了吧。` },
  "INFLU": { code: "INFLU", cn: "职场网红粉", intro: "那个博主说这样汇报最有效！", desc: `恭喜你，你是职场知识付费的忠实用户。你关注了47个职场博主，你的收藏夹比你的大脑更有知识。你学过的课比你看过的书多，你记过的笔记比你做过的事多。职场网红粉的悲剧：买课如山倒，做事如抽丝。` },
  "NOVA": { code: "NOVA", cn: "职场焦虑制造机", intro: "完了完了，这个没做过怎么办？", desc: `恭喜你，你是职场焦虑发生器。你对任何新任务的第一反应永远是恐惧，你觉得每一个困难都能要了你的命。你在做事之前就开始焦虑，你在焦虑之中忘了做事。焦虑制造机，你的情绪是部门里最贵的成本，因为大家都要花时间安抚你。` },
  "LITE": { code: "LITE", cn: "职场多面手", intro: "我同时在推进七个项目。", desc: `恭喜你，你是职场多线程处理器。你同时开很多个窗口，同时聊很多个群，同时推进很多个项目。你的一天是别人的三天，你的注意力是别人的十分之一。但多面手的诅咒：每一面都沾一点，每一面都不精。` },
  "DRUNK2": { code: "DRUNK2", cn: "职场流浪汉", intro: "我就看看机会，不急着换。", desc: `恭喜你，你是职场流浪汉。你永远在招聘网站闲逛，你永远在看新机会，但你就永远不迈出那一步。你的简历更新了47版，你的面试参加了0场。职场流浪汉的人生：看遍所有机会，却一个都不属于我。` },
  "NOBUD": { code: "NOBUD", cn: "穷忙族", intro: "我这么忙工资还是这么点。", desc: `恭喜你，你是穷忙族的代言人。你的工资涨幅永远赶不上你的工作量，你的付出永远换不回等量的回报。你是公司里最忙的人，也是最穷的人。穷忙族的财务状态：工资月月光，加班天天有，卡债永远在。` },
  "PROBI": { code: "PROBI", cn: "专业人士", intro: "这个应该走那个流程。", desc: `恭喜你，你是流程的守护者，规则的忠实粉丝。你说话中英混杂，"这个应该走那个workflow"——你的存在让整个公司的流程越来越复杂，也让你的存在感越来越低。专业人士的悲剧：别人觉得你在秀英语，其实你只是在说流程。` },
  "HHHH2": { code: "HHHH2", cn: "傻乐打工人", intro: "哈哈哈哈，今天居然没加班！", desc: `恭喜你！由于你的职场回路过于清奇，标准人格库已无法定义你。HHHH型人格是系统为极其稀有的职场体验者保留的神秘人格。你不焦虑不纠结不内耗，你觉得上班就是上班，下班就是下班。别人在为KPI失眠，你在为看什么剧纠结。你的快乐是职场里最后的乌托邦。` },
};
